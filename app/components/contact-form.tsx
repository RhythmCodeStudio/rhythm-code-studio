...
export default function ContactForm() {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>, setState: React.Dispatch<React.SetStateAction<any>>) => {
  ...
  return (
    <div className="p-8 m-4 w-full">
      <form
        ...
        <div className="flex flex-col py-2">
          <label htmlFor="email" className="px-4">Brief Project Description*<span className="text-xs"> (required)</span></label>
          <textarea
            autoComplete="off"
            maxLength={1000}
