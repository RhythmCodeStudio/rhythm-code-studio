  ...
  return (
    <section className="flex flex-col items-center justify-content space-y-16 mb-12">
      ...
      <div className="px-8 lg:w-200 lg:text-lg xl:text-xl">
        ...
        <p className="my-4">
          We utilize modern web technologies that platforms like Squarespace,
          Wix, and WordPress simply can&apos;t match. Our work is fast, secure,
          fully responsive, and fully accessible. We develop web solutions with
          a pulse, ones that match your personal rhythm and style.
        </p>
        <p className="mt-4">
